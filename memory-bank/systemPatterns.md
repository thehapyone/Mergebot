...
- GitLab as the initial and primary VCS integration target, with roadmap for GitHub/other VCS
...
- MR event triggers or CI/CD pipeline → Core engine → Crew execution → Feedback aggregation → GitLab update → Dashboard update → Memory Bank documentation
