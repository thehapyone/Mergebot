...
async def run_flow(
    ...
    if project and get_platform_type() == "gitlab":
        ...
        # Check for .mergebot.yml in the default branch and merge if found
        ...
        if mergebot_yml:
            try:
                ...
                logger.info("Loaded and merged .mergebot.yml from repo.")
            except Exception as e:
                logger.error(f"Failed to parse .mergebot.yml: {e}")
        else:
